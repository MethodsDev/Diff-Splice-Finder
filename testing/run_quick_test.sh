...
test -f quick_test_output/workdir/introns_clustered.tsv && echo "  ✓ workdir/introns_clustered.tsv"
test -f quick_test_output/workdir/shared_offsets.tsv && echo "  ✓ workdir/shared_offsets.tsv"
